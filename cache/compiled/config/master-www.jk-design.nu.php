...
return [
    ...
    'timestamp' => 1523667304,
    'checksum' => '6e6f552936d03ef43654c62ef54588db',
    'files' => [
        'user/config' => [
            'media' => [
    ...
    'data' => [
        ...
        'site' => [
            ...
            'metadata' => [
                'description' => 'JK Design - your one stop for graphics, logos, branding and modern web designs.'
            ],
            'summary' => [
                'enabled' => true,
                'format' => 'short',

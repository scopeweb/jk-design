...
class __TwigTemplate_20d1913b450e0a5165962d5f00b899e1b3c0827c4e581e23eeaeb7a3df004876 extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t<input autocomplete=\"on\" class=\"form-control\" name=\"name\" placeholder=\"Enter your name\" required=\"required\" type=\"text\" value=\"\">
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t<div class=\"form-input-wrapper\">
\t\t\t\t\t\t\t\t\t<input class=\"form-control\" name=\"_replyto\" placeholder=\"Enter your email address\" required=\"required\" type=\"email\" value=\"\">
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
\t\t\t\t\t\t<div class=\"form-field\">
\t\t\t\t\t\t\t<div class=\"form-label\">
\t\t\t\t\t\t\t\t<label class=\"inline\">Messages <span class=\"required\">*</span></label>
\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t<div class=\"col-lg-12 text-center\">
\t\t\t\t\t\t<div class=\"form-group\">
\t\t\t\t\t\t\t<button class=\"btn btn-primary btn-lg\" type=\"submit\" value=\"Send\">Submits</button>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t</form>
